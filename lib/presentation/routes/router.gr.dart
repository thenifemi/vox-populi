...
import '../../Domain/news/article.dart' as _i14;
import '../../Domain/user/user.dart' as _i13;
import '../article/article_screen.dart' as _i11;
import '../article/widgets/article_webview_widget.dart' as _i12;
...
class AppRouter extends _i1.RootStackRouter {
  ...
  List<_i1.RouteConfig> get routes => [
        ...
        _i1.RouteConfig(ArticleWebviewWidgetRoute.name,
...
class SettingsScreenRoute extends _i1.PageRouteInfo<SettingsScreenRouteArgs> {
  SettingsScreenRoute({_i2.Key? key, required _i13.User profile})
      : super(name,
...
class EditProfileScreenRoute
  ...
  EditProfileScreenRoute({_i2.Key? key, required _i13.User profile})
      : super(name,
            path: '/edit-profile-screen',
...
class ArticleScreenRoute extends _i1.PageRouteInfo<ArticleScreenRouteArgs> {
  ArticleScreenRoute({_i2.Key? key, _i14.Article? article})
      : super(name,
            path: '/article-screen',
